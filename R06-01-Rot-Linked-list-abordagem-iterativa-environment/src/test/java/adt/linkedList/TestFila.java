...
public class TestFila {
	...
	public void setUp() throws QueueOverflowException {
		fila = new QueueDoubleLinkedListImpl<>(4);
		filaCheia = new QueueDoubleLinkedListImpl<>(3);
		filaVazia = new QueueDoubleLinkedListImpl<>(1);
		random = new QueueDoubleLinkedListImpl<>(5);
